//
//  AddPlanCoursesViewController.swift
//  Courses
//
...
class AddPlanCoursesViewController: UIViewController, PlanCoursesViewDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "preview" {
            ...
            vc.presenter.course.id = presenter.idCourse
            vc.interface = role
        }
...
extension AddPlanCoursesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        presenter.days[indexPath.section].modules[indexPath.row].module.isVisible.toggle()
        modulesCollectionView.reloadData()
    }
